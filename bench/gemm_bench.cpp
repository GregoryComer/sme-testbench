...
void BM_gemm_f32p_f32p_f32_4vlxvl(benchmark::State& state) {
...
BENCHMARK(BM_gemm_f32p_f32p_f32_4vlxvl)
    ->Args({1, 1024, 1024})
    ->Args({1, 4096, 4096})
    ->Args({16, 1024, 1024})
    ->Args({16, 4096, 4096})
...
void BM_gemm_f32p_f32p_f32_2vlx2vl(benchmark::State& state) {
  const size_t M = static_cast<size_t>(state.range(0));
  const size_t N = static_cast<size_t>(state.range(1));
  const size_t K = static_cast<size_t>(state.range(2));
...
BENCHMARK(BM_gemm_f32p_f32p_f32_2vlx2vl)
    ->Args({1, 1024, 1024})
    ->Args({1, 4096, 4096})
    ->Args({16, 1024, 1024})
    ->Args({16, 4096, 4096})
