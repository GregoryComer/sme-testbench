...
class GemmF16Test : public ::testing::TestWithParam<GemmShape> {};

TEST_P(GemmF16Test, MatchesReference) {
  auto [M, N, K] = GetParam();

  auto pack = sme::gemm_f16_packing_params();
  ...
  sme::gemm_f16p_f16p_f16(p, lhs_packed.get(), rhs_packed.get(), C.data());
...
INSTANTIATE_TEST_SUITE_P(
    EpilogueSingleTile, GemmF16Test,
    ::testing::Values(
        GemmShape{16, 16, 2},
        GemmShape{16, 16, 16}
    ),
