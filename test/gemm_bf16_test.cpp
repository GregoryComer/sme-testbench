...
class GemmBF16_4vlxvlTest : public ::testing::TestWithParam<GemmShape> {};

TEST_P(GemmBF16_4vlxvlTest, MatchesReference) {
  auto [M, N, K] = GetParam();

  auto pack = sme::gemm_bf16_4vlxvl_packing_params();
...
INSTANTIATE_TEST_SUITE_P(PartialTiles, GemmBF16_4vlxvlTest,
    ::testing::Values(
...
class GemmBF16_2vlx2vlTest : public ::testing::TestWithParam<GemmShape> {};

TEST_P(GemmBF16_2vlx2vlTest, MatchesReference) {
  auto [M, N, K] = GetParam();

  auto pack = sme::gemm_bf16_2vlx2vl_packing_params();
  ...
  sme::pack_bf16(A.data(), M, K, pack.lhs, lhs_packed.get());
  sme::pack_bf16(B.data(), K, N, pack.rhs, rhs_packed.get());
  sme::gemm_bf16p_bf16p_bf16_2vlx2vl(p, lhs_packed.get(), rhs_packed.get(), C.data());
  sme::gemm_bf16_bf16_bf16_reference(p, A.data(), B.data(), C_ref.data());

  expect_near(C.data(), C_ref.data(), M * N, K);
}

INSTANTIATE_TEST_SUITE_P(EpilogueSingleTile, GemmBF16_2vlx2vlTest,
    ::testing::Values(GemmShape{16, 16, 2}, GemmShape{16, 16, 16}), shape_name);

INSTANTIATE_TEST_SUITE_P(EpilogueStrides, GemmBF16_2vlx2vlTest,
    ::testing::Values(
        GemmShape{32, 16, 2}, GemmShape{16, 32, 2}, GemmShape{32, 32, 2},
        GemmShape{48, 16, 2}, GemmShape{32, 16, 4}, GemmShape{32, 32, 4}),
    shape_name);

INSTANTIATE_TEST_SUITE_P(MainBody, GemmBF16_2vlx2vlTest,
    ::testing::Values(
        GemmShape{64, 16, 2}, GemmShape{64, 32, 2}, GemmShape{64, 16, 16},
        GemmShape{128, 16, 2}, GemmShape{128, 32, 4}, GemmShape{80, 16, 2},
        GemmShape{96, 32, 4}, GemmShape{128, 128, 16}),
...
INSTANTIATE_TEST_SUITE_P(PartialTiles, GemmBF16_2vlx2vlTest,
    ::testing::Values(
        GemmShape{17, 16, 2}, GemmShape{16, 17, 2}, GemmShape{16, 16, 3},
        GemmShape{17, 17, 3}, GemmShape{33, 17, 5}, GemmShape{65, 16, 2},
        GemmShape{64, 17, 2}, GemmShape{64, 16, 5}, GemmShape{65, 17, 5},
